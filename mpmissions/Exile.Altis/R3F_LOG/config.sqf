...
[
	...
	// Here Comes the Vehicle which can Load Stuff 	
		...
		["Exile_Chopper_Mohawk_FIA", 20],
		["I_Heli_light_03_F", 20],
		["Exile_Chopper_Hummingbird_Green", 20],
		["Exile_Chopper_Hummingbird_Civillian_Blue", 20],
		["Exile_Chopper_Hummingbird_Civillian_Red", 20],
		["Exile_Chopper_Hummingbird_Civillian_ION", 20],
		["Exile_Chopper_Hummingbird_Civillian_BlueLine", 20],
		["Exile_Chopper_Hummingbird_Civillian_Digital", 20],
		["Exile_Chopper_Hummingbird_Civillian_Elliptical", 20],
		["Exile_Chopper_Hummingbird_Civillian_Furious", 20],
		["Exile_Chopper_Hummingbird_Civillian_GrayWatcher", 20],
		["Exile_Chopper_Hummingbird_Civillian_Jeans", 20],
		["Exile_Chopper_Hummingbird_Civillian_Light", 20],
		["Exile_Chopper_Hummingbird_Civillian_Shadow", 20],
		["Exile_Chopper_Hummingbird_Civillian_Sheriff", 20],
		["Exile_Chopper_Hummingbird_Civillian_Speedy", 20],
		["Exile_Chopper_Hummingbird_Civillian_Sunset", 20],
		["Exile_Chopper_Hummingbird_Civillian_Vrana", 20],
		["Exile_Chopper_Hummingbird_Civillian_Wasp", 20],
		["Exile_Chopper_Hummingbird_Civillian_Wave", 20],
...
[
	...
	["IG_supplyCrate_F", 6],
	["Box_IND_AmmoVeh_F", 6],
	["Exile_Bike_OldBike", 6],
	["Exile_Bike_MountainBike", 6],
	["Exile_Bike_Crosser", 6]
