...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Vehicles_MH9 + IL_Supported_Bicycles;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV +IL_Supported_Bicycles + IL_Supported_OFFROAD;
...
if (isnil "IL_Procedures") then
{
	...
	//TEST to lock items loaded on trucks
				
						if ((typeOf _x) in (IL_Supported_Box_H1 )) then
				{
						...
						if ((typeOf _x) in (IL_Supported_Cargo20)) then
				{
					_x setVariable ["R3F_LOG_disabled",true,true];
						...
						if ((typeOf _x) in (IL_Supported_TaruPods )) then
				{
					_x setVariable ["R3F_LOG_disabled",true,true];
				};
						if ((typeOf _x) in (IL_Supported_Bicycles )) then
				{
					_x setVariable ["R3F_LOG_disabled",true,true];
				};
	...
	IL_Do_Unload =
	{
		...
		if (count (_obj_lst) > 0) then
		{
			...
			//TEST to unlock items offloaded from trucks
